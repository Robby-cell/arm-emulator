...
SVC 0           @ Trigger Supervisor Call
        ...
        &lt;h2&gt;1. الواجهة&lt;/h2&gt;
        &lt;ul&gt;
            &lt;li&gt;&lt;b&gt;المحرر:&lt;/b&gt; اكتب مجموعة ARM الخاصة بك هنا. انقر على الهامش (الهامش الأيسر) لتعيين &lt;b&gt;نقاط التوقف&lt;/b&gt; (النقاط الحمراء).&lt;/li&gt;
            &lt;li&gt;&lt;b&gt;لوحة وحدة المعالجة المركزية (يمين):&lt;/b&gt; شاهد السجلات (R0-R15) وأعلام CPSR (N، Z، C، V) تتغير في الوقت الفعلي. يتم تمييز القيم التي تم تغييرها باللون الأحمر.&lt;/li&gt;
            &lt;li&gt;&lt;b&gt;عرض الذاكرة:&lt;/b&gt; افحص ذاكرة الوصول العشوائي الأولية بايت بايت. قم بالتمرير بشكل لا نهائي خلال مساحة العنوان البالغة 4 جيجابايت.&lt;/li&gt;
            &lt;li&gt;&lt;b&gt;التفكيك:&lt;/b&gt; تعرف بالضبط على كيفية تجميع نص التجميع الخاص بك في كود الجهاز وكيف تفسره وحدة المعالجة المركزية.&lt;/li&gt;
        &lt;/ul&gt;

        &lt;h2&gt;2. الضوابط والاختصارات&lt;/h2&gt;
        &lt;ul&gt;
            &lt;li&gt;&lt;code&gt;F7&lt;/code&gt; - &lt;b&gt;تحميل/إنشاء:&lt;/b&gt; يجمع التعليمات البرمجية الخاصة بك ويحملها في الذاكرة عند &lt;code&gt;0x00000000&lt;/code&gt; دون بدء التنفيذ.&lt;/li&gt;
            &lt;li&gt;&lt;code&gt;F5&lt;/code&gt; - &lt;b&gt;تشغيل:&lt;/b&gt; ينفذ التعليمات البرمجية بشكل مستمر حتى نقطة التوقف أو استدعاء الخروج.&lt;/li&gt;
            &lt;li&gt;&lt;code&gt;F10&lt;/code&gt; - &lt;b&gt;الخطوة:&lt;/b&gt; ينفذ تعليمة واحدة بالضبط. رائعة لمشاهدة تغير السجلات!&lt;/li&gt;
            &lt;li&gt;&lt;code&gt;Shift+F5&lt;/code&gt; - &lt;b&gt;إيقاف:&lt;/b&gt; يوقف البرنامج قيد التشغيل.&lt;/li&gt;
            &lt;li&gt;&lt;code&gt;Ctrl+R&lt;/code&gt; - &lt;b&gt;إعادة الضبط:&lt;/b&gt; يمسح حالة وحدة المعالجة المركزية، ويعيد التشغيل، ويعيد ضبط جميع الأجهزة الطرفية.&lt;/li&gt;
        &lt;/ul&gt;

        &lt;h2&gt;3. الأجهزة الطرفية (LED)&lt;/h2&gt;
        &lt;p&gt;يمكنك محاكاة أجهزة حقيقية. أضف جهازًا طرفيًا &lt;b&gt;منفذ GPIO&lt;/b&gt; تم تعيينه إلى عنوان (على سبيل المثال، &lt;code&gt;0x40000000&lt;/code&gt;).&lt;/p&gt;
        &lt;p&gt;لتشغيل مؤشر LED، يجب عليك كتابة بتات محددة إلى السجلات المعينة للذاكرة الخاصة به:&lt;/p&gt;
        &lt;قبل&gt;
LDR R0, =led0 @ قم بتحميل العنوان الأساسي للجهاز الطرفي
موف آر1، #0x400
STR R1، [R0] @ اكتب إلى MODER (الإزاحة 0x00) لتعيينه كمخرج
موف آر 1، #0x20
STR R1، [R0، #0x14] @ اكتب إلى ODR (الإزاحة 0x14) لتشغيل مؤشر LED عاليًا
        &lt;/قبل&gt;
